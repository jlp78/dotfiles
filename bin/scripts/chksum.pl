...
sub initialize {
    ...
    my $elist = ['--exclude' => '/var',
                 ...
                 '--exclude' => '/etc/.updated',
                 '--exclude' => '/etc/cloud/clean.d/99-installer',
                 '--exclude' => '/etc/cloud/cloud.cfg.d/99-installer.cfg',
                 '--exclude' => '/etc/cups/subscriptions.conf.0',
                 '--exclude' => '/etc/cups/subscriptions.conf',
                 '--exclude' => '/etc/fstab',
                 '--exclude' => '/etc/hostname',
                 '--exclude' => '/etc/hosts',
                 '--exclude' => '/etc/machine-id',
                 '--exclude' => '/etc/netplan/90-NM-cac41fbe-bc18-3d87-bba7-af2af7f8ffab.yaml',
                 '--exclude' => '/etc/shadow',
                 '--exclude' => '/etc/shadow-',
                 '--exclude' => '/etc/ssh/ssh_host_',
                 '--exclude' => '/etc/ssl/certs',
                 '--exclude' => '/etc/ssl/private',
                 '--exclude' => '/usr/NX/etc/keys',
                 '--exclude' => '/usr/NX/etc/nxdb',
                 '--exclude' => '/usr/NX/etc/server.lic',
                 '--exclude' => '/usr/NX/etc/uuid',
                 '--exclude' => '/usr/NX/var',
                 '--exclude' => '/usr/share/fonts',
                 '--exclude' => '/usr/share/info/dir',
                 '--exclude' => '/usr/share/info/dir.old',
                ];
